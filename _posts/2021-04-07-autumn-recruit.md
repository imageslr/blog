...
简历从上到下大致为：个人信息、教育背景、实习经历、项目经历、荣誉奖励、专业技能/英文水平/个人评价等。采用 [STAR 法则](https://www.google.com/search?q=star%E6%B3%95%E5%88%99)描述自己的项目和实习经历。我的简历模板：

![](/media/04-28-23-04-56.png)

简历可以使用在线平台制作，如乔布简历、超级简历 CV 等，也可以使用 PS / Sketch 制作。拒绝花花绿绿、华而不实的风格。最好放在一页上，如果一页放不下，可以缩小字体/间距，或改变页面大小。简历导出为 PDF 格式，命名为“名字_岗位_手机号”。
...
项目经历应该怎么写？[知乎的这个问题](https://www.zhihu.com/question/23491167)可以参考，[geekcompany/ResumeSample](https://github.com/geekcompany/ResumeSample) 提供了一系列程序员的简历模板，[resumejob/awesome-resume](https://github.com/resumejob/awesome-resume) 则提供了许多程序员的简历例句。
...
简历里的项目经历、实习经历是最有可能被面试官作为第一个问题的，所以应该对这些内容提前准备。特别是“如果这个任务再做一次，你想怎么改进？”“任务中最难的一点是什么，你怎么攻克的？”
