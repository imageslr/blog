...
set height 0 set width 0  // 否则如果一页显示不完，会停下来要求 continue
```
...
Github 提供了一些[开箱即用的 ~/.gdbinit 文件](https://github.com/gdbinit/Gdbinit/blob/master/gdbinit)。
...
* [STL views](https://sourceware.org/gdb/wiki/STLSupport)：打印 STL 容器的值
